...
%% User input
%Prompt questions
prompt = {'Continuous (0) or segmented (1) data?','Enter the prefix of your participant filename','Baseline Offset (data points; mark 0 if continuous)','What is your sampling rate', 'If applicable, What is the size of your segments (ms)', 'Fix oddball data? 1 = yes, 0 = no'};
