%Note: This script was adapted by the orignial pop_writebva script
...
if ~isempty(EEG.event)
    ...
    for index = 1:length(e)
        ...
        fprintf(fid2, 'Mk%s=%s,%s,%s,%s,0,0\n', num2str(e(index).mknum),e(index).type, tmpcom, e(index).latency, num2str(tmpdur));
    end;
end
fclose(fid1);
fclose(fid2);
